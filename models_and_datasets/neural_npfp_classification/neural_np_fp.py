...
def steps(trial, data):
    ...
    model_mode = trial.suggest_categorical('model_mode', ['aux', 'base', 'ae'])
    featurizer = NeuralNPFP(model_name=model_mode)
...
po = PipelineOptimization(direction='maximize', study_name='neural_npfp', storage='sqlite:///neural_npfp.db')
